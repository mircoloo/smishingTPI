...
<div className="telldata-search-bar">
  <div className="telldata-search">
      <input id="telldata-search-number" placeholder="Search number informations..." type="text"></input>
      <button onClick={searchOne}>Search</button>
  </div>
  <div className="telldata-search">
      <input id="telldata-search-keywords" placeholder="Search keywords..." type="text"></input>
