  ...
  return (
      <div className="comment">
        <div className="comment-right-part">
          ...
          <div className='feedbacks'> <span className='feedback' style={{color: 'green'}} onClick={addLike}><i className="fa fa-thumbs-up" />{like}</span> <span className='feedback' style={{color: 'red'}} onClick={addDislike}><i className="fa fa-thumbs-down" />{dislike}</span>  </div>
          {replies.length > 0 && (
